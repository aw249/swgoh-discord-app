...
export   function generateGalacticLegends(
    ...
    // Tenacity uses protection icon (both defensive), Potency uses health icon (both offensive)
    const tenacityIconBase64 = 'data:image/webp;base64,';
