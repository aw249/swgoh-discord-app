...
import { scoreCronOnSquad, TIER_WEIGHTS } from './scoring';
import { hungarianMaximise } from './hungarian';

/**
 * A score at or below this threshold means no faction or character primary
 * landed — the cron contributes only stat weights and is "filler" for that squad.
 */
export const FILLER_THRESHOLD = 6 * TIER_WEIGHTS.stat;
